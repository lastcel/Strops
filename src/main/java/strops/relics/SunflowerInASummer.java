...
public class SunflowerInASummer extends StropsAbstractRelic {
    ...
    public static final IntSliderSetting ISELITELIZE=new IntSliderSetting("Iriya_IsElitelize_v0.12.0","B1",0,1);
    ...
    public ArrayList<String> getUpdatedDescription2() {
        ...
        if(ISELITELIZE.value==0){
            ...
            str_out.add(this.DESCRIPTIONS[5]);
        }
        str_out.add("");
