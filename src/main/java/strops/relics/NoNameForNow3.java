...
public class NoNameForNow3 extends StropsAbstractRelic{
    public static final String ID = ModHelper.makePath(NoNameForNow3.class.getSimpleName());
    private static final String IMG_PATH = ModHelper.makeIPath(NoNameForNow3.class.getSimpleName());
