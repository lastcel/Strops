...
public class StackedPlate extends StropsAbstractRelic{
    ...
    public static final IntSliderSetting BASE=new IntSliderSetting("StackedPlate_Base_v0.12.0", "N1", NUM1, 2);
    public static final IntSliderSetting BONUS=new IntSliderSetting("StackedPlate_Bonus_v0.12.0", "N2", NUM2, 1,4);
    //public static final IntSliderSetting THRESHOLD=new IntSliderSetting("StackedPlate_Threshold", "N2", NUM2, 1,17);
    public static final IntSliderSetting MH=new IntSliderSetting("StackedPlate_MH_v0.12.0","MH",0,-20,20);
    public static final IntSliderSetting G=new IntSliderSetting("StackedPlate_G_v0.12.0","G",0,-100,100);
