...
import strops.patch.PatchNoNameForNow4;
...
public class NoNameForNow4 extends StropsAbstractRelic implements CustomBottleRelic, CustomSavable<ArrayList<Integer>>, OnAfterUseCardRelic {
    public static final String ID = ModHelper.makePath(NoNameForNow4.class.getSimpleName());
    private static final String IMG_PATH = ModHelper.makeIPath(NoNameForNow4.class.getSimpleName());
    //private static final String IMG_PATH_O = ModHelper.makeOPath(NoNameForNow4.class.getSimpleName());
    private static final LandingSound LANDING_SOUND = LandingSound.SOLID;

    private boolean cardSelected=true;

    public static final int NUM1=6,NUM2=2,NUM3=2,TIER=5;
    ...
    public Predicate<AbstractCard> isOnCard() {
        return PatchNoNameForNow4.PatchTool1.inNoNameForNow4::get;
    }
    ...
    public ArrayList<Integer> onSave() {
        ...
        for(AbstractCard c:AbstractDungeon.player.masterDeck.group){
            if(PatchNoNameForNow4.PatchTool1.inNoNameForNow4.get(c)){
    ...
    public void onLoad(ArrayList<Integer> cardsIndex) {
        for(int i:cardsIndex){
            if(i>=0&&i<AbstractDungeon.player.masterDeck.group.size()){
                ...
                if(card!=null){
                    PatchNoNameForNow4.PatchTool1.inNoNameForNow4.set(card,true);
                }
            }
        }
    }
    ...
    public void onEquip(){
        ...
        if(cardGroup.size()<=RECEPTOR.value){
            ...
            for(AbstractCard c:cardGroup.group){
                PatchNoNameForNow4.PatchTool1.inNoNameForNow4.set(c,true);
            }
        } else {
    ...
    public void onUnequip() {
        for (AbstractCard c : AbstractDungeon.player.masterDeck.group) {
            PatchNoNameForNow4.PatchTool1.inNoNameForNow4.set(c, false);
        }
    }
    ...
    public void onAfterUseCard(AbstractCard cardIn, UseCardAction action){
        if(PatchNoNameForNow4.PatchTool1.inNoNameForNow4.get(cardIn)){
