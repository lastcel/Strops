...
public class SoulCannonTwoHuge extends StropsAbstractRelic implements ClickableRelic {
    ...
    @Override
    public void onEquip(){
        //BaseMod.logger.info("拾起时，获取到计数="+PatchSoulCannon.PatchTool1.notUsedCannonTurn.get());
    ...
    public String getUpdatedDescription() {
        if(AbstractDungeon.player!=null){
            decideFormat();
            //BaseMod.logger.info("获得升级描述，幕数="+AbstractDungeon.actNum);
            //BaseMod.logger.info("未用回合数="+PatchSoulCannon.PatchTool1.notUsedCannonTurn.get());
    ...
    public void updateFormat(){
        //BaseMod.logger.info("幕数="+AbstractDungeon.actNum);
        if(counter>=WARMUP.value){
            return;
        }
        decideFormat();
    ...
    public ArrayList<String> getUpdatedDescription2() {
        ...
        if(AbstractDungeon.player!=null) {
            decideFormat();
            //BaseMod.logger.info("g2，幕数="+AbstractDungeon.actNum);
            //BaseMod.logger.info("g2，未用回合数="+PatchSoulCannon.PatchTool1.notUsedCannonTurn.get());
            if(PatchSoulCannon.PatchTool1.notUsedCannonTurn.get()>=WARMUP.value){
    ...
    public void setCounter(int counter){
        ...
        //BaseMod.logger.info("设定计数，计数="+AbstractDungeon.actNum);
