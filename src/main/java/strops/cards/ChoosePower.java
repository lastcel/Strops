...
public class ChoosePower extends CustomCard {
    ...
    public void onChoseThisOption() {
        ((Wedgue) PatchStrongestPotion.PatchTool1.whichCallThis.get(AbstractDungeon.cardRewardScreen)).condition = Wedgue.Condition.POWER;
