...
public class Choose0Cost extends CustomCard {
    public static final String ID = ModHelper.makePath(Choose0Cost.class.getSimpleName());
    private static final CardStrings CARD_STRINGS = CardCrawlGame.languagePack.getCardStrings(ID);
    private static final String NAME = CARD_STRINGS.NAME;
    private static final String IMG_PATH = "StropsResources/img/cards/Choose0Cost.png";
